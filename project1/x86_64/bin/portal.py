...
transfer_to_perfdmf, transfer_to_portal, host = "tau.nic.uoregon.edu"):
  if (experiment is None):
    for exp in os.popen("/home/oscarteeninga/Downloads/tau-2.31/x86_64/bin/perfdmfdb.py list_experiments '" + application + "'").readlines():
...
transfer_to_perfdmf, transfer_to_portal, host = "tau.nic.uoregon.edu"):  
  ...
  perfdmf_trials = []
  for trial in os.popen("/home/oscarteeninga/Downloads/tau-2.31/x86_64/bin/perfdmfdb.py list '" + application + "' '" + experiment
  + "'").readlines():
  ...
  if (transfer_to_portal):
    ...
    to_portal, host):
      ...
      for trial in to_portal:
        os.popen("/home/oscarteeninga/Downloads/tau-2.31/x86_64/bin/perfdmfdb.py download '" + application + "' '" + experiment +
        "' " + trial)
  ...
  if (transfer_to_perfdmf):
    ...
    #print "/home/oscarteeninga/Downloads/tau-2.31/x86_64/bin/perfdmfdb.py upload " + application + " " + experiment + " " + to_perfdmf_list 
    os.popen("/home/oscarteeninga/Downloads/tau-2.31/x86_64/bin/perfdmfdb.py upload '" + application + "' '" + experiment + "' " + to_perfdmf_list) 
